...
public class LicenseTest {
    ...
    public static Long   julianDate  = sysdate.getTime();
    public static String VENDOR      = "ACME";
    public static Date   GENERATED   = new Date(julianDate);
    public static Date   EXPIRED     = new Date(julianDate + (100000L * 100000));
    ...
    public void licensorTest() {
        ...
        assertNotNull(f, "Cannot get license feature");
        assertEquals(f.getExpiration(), EXPIRED.getTime());
        assertTrue(f.getVendorName().equalsIgnoreCase(VENDOR), "Feature vendor missing");
        ...
        System.out.println("Licensor test passed");
    ...
    public void licenseeTest() {
        ...
        assertTrue(isValid, "Valid license failed the verification");

        System.out.println("Licensee test passed");
    }
}
